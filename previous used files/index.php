...
<!-- loding icon show  -->
                        ...
                        <!-- each file start -->
                            ...
                            <div class="p-1">
                                    ...
                                    <a class="renameIcon card-link" onclick="renameFile('<?php echo $nextDir; ?>','<?php echo $eachFile; ?>' )"></a>
                                    <a id="renameFile" class="renameIcon card-link" data-oldfilename='<?php echo $eachFile; ?>' data-currentDir= '<?php echo $nextDir; ?>'> 
