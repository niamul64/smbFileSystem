...
function searchfiles($folder){
    ...
    foreach ($filesAndDir as $eachFile){ 
        if (is_dir($folder.'/'.$eachFile)){ // if it is dir then recursive call
            searchfiles($folder.'/'.$eachFile);
...
?>
 ...
 <div id='fileShow'  class="fileShowCard me-2 ms-2 m-1 float-start card col-12 col-xl-3 col-lg-4 col-md-5 col-sm-10" > 
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle mb-2 text-muted cardTitleSelect"><?php  echo number_format($eachFile[0],2,'.','').'MB';?></h6>
                                    <p class="card-text">
                                    ...
                                    <a class="renameIcon card-link" onclick="renameFile('<?php echo $nextDir; ?>','<?php echo $eachFile[1]; ?>' )"> 
